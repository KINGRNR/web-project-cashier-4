{{-- <div class="row mb-5 w-75 mx-auto">
    ...
    <div class="card">
        ...
        <div class="card-header py-4">
            ...
            <div class="card-toolbar">
                ...
                data-bs-toggle="modal" data-bs-target="#kt_modal_add_example">Add Menu</button>
                <div class="d-flex">
        ...
        <div class="card-body pt-0 overflow-auto">
            ...
            <!--begin::Table-->
            <table class="table align-middle table-hover  table-row-dashed fs-6 gy-5 text-center" id="table-menu">
                <!--begin::Table head-->
                <thead>
                    <!--begin::Table row-->
                    <tr class="text-start align-middle text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px">Kode Menu</th>
                        <th class="min-w-125px">Nama Menu</th>
                        <th class="min-w-125px">Akses</th>
                        <th class="min-w-125px">Urutan Menu</th>
                        <th class="min-w-125px">Letak Folder</th>
                        <th class="min-w-125px">Apakah Punya Parent?(id)</th>
    ...
    <div class="modal fade" id="kt_modal_add_example" tabindex="-1" aria-hidden="true">
        @include('superadmin.makemodule.form')
    </div>
{{--     <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.10.25/css/jquery.dataTables.min.css">
 ...
 --}}
    @include('superadmin.makemodule.javascript')
